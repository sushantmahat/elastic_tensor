...
direction_plt_name = 'Data/C11_' + str(C11_old) + 'C44_' + str(C44_old) + '_direction_plt'

direction_file = open('Data/C11_C44_directions', 'w')
direction_curtailed = open('Data/C11_C44_fit_directions_lim', 'w')
...
#    stiffness_tensor[2,1] = C12
    ...
    for j in range(numC44):
        ...
        direction_plt.write(str(C11)+'\t'+ str(C44)+ '\t'+ str(val_SAD) +'\n')
...
print('minimum value for fit is ' + str(compare_val) + 'for ' + 'C11 of ' + str(min_point[0]) +' and C44 of ' + str(min_point[1]) + ' and highest differences is in direction ' + highest_AD_dir_for_lowest_SAD) + ' @ ' + highest_AD_for_lowest_SAD        
