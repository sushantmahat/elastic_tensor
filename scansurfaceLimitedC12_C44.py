...
direction_plt_name = 'C12_' + str(C12_old) + 'C44_' + str(C44_old) + '_direction_plt'
direction_file = open('C12_C44_directions', 'w')
direction_curtailed = open('C12_C44_fit_directions_lim', 'w')
...
for i in range(numC12):
    ...
    for j in range(numC44):
        ...
        for q in directions:
            ...
            closest_sec = velDsec1 if velDsec1<velDsec2 else velDsec2
            #find closest secondary velocity
