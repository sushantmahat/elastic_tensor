...
for q in directions:
    ...
    #direction_file.write(' Primary Group: ' + str(group_vel[2]) + ' km/s\n')
    #direction_file.write(' Primary pf angle: ' + str(pf_angle[2]) + '\n')
    direction_file.write(' Secondary 1: ' + str(velocity[1]) + ' km/s\n')
    #direction_file.write(' Secondary 1 group: ' + str(group_vel[1]) + ' km/s\n')
    #direction_file.write(' Secondary 1 pf angle: ' + str(pf_angle[1]) + '\n')
    direction_file.write(' Secondary 2: ' + str(velocity[0]) + ' km/s\n')
    #direction_file.write(' Secondary 2 Group: ' + str(group_vel[0]) + ' km/s\n')
    #direction_file.write(' Secondary 2 pf angle: ' + str(pf_angle[0]) + ' \n')
